...
class LunaTrainingApp:
    ...
    def logMetrics(
        ...
        negHist_mask = negLabel_mask & (metrics_t[METRICS_PRED_ND] > 0.01)
        ...
        if posHist_mask.any():
            writer.add_histogram(
                ...
                self.totallTrainingSamples_count,
                bins=bins,
            )
        ...
        #         return score
    #     def logModuleMetrics(self, model):
    #         writer = getattr(self, 'trn_writer')

    #         model = getattr(model, 'module', model)

    #         for name, param in model.naemd_parameters():
